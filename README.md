...
# Ask Database: Talk to a Database  
...
then executing that query on MySQL database. A store manager 
...
- .env: Configuration file for storing your Google API key."# Ask_Database" 
